...
//        driver = getDriver();
    ...
    public void enterFirstNameAsAndLastNameAsRandom(String firstname) throws InterruptedException {
        ...
        Thread.sleep(1000);
        fourty.until(ExpectedConditions.visibilityOfElementLocated(By.id("RegisterIndividual:LastName"))).sendKeys(getRandom(5));
//        fourty.until(ExpectedConditions.visibilityOfElementLocated(By.id("RegisterIndividual:LastName"))).sendKeys("aro");
    ...
    public void fillInPassportIdentificationDetails() throws InterruptedException {
        ...
        Thread.sleep(1000);
        driver.findElement(By.xpath("//li[contains(text(),'Malawi')]")).click();
    ...
    @Then("Fill in National ID Identification details")
    public void fillInNationalIdentificationDetails() throws InterruptedException {
        ten.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[contains(., 'Identification')]"))).click();
        ...
        fourty.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"Identification:IdentificationType\"]/div[3]"))).click();
        Thread.sleep(1000);
        driver.findElement(By.xpath("//li[contains(text(),'NID Card')]")).click();
        Thread.sleep(3000);
        ...
        driver.switchTo().defaultContent();
        thirty.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//td[contains(text(),'NID Card" +
                "')]"))).isDisplayed();
    }
    ...
    public void fillInResidencePermitIdentificationDetails() throws InterruptedException {
        ...
        fourty.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"Identification:CountryOfIssue\"]/div[3]"))).click();
        Thread.sleep(4000);
        ten.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li[contains(text(),'Malawi')]"))).click();
//        driver.findElement(By.xpath("//li[contains(text(),'Malawi')]")).click();
    ...
    public void fillInOccupationAndBusinessInterestDetailsForIndividual() throws InterruptedException {
        ...
        ten.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"RegisterIndividual:individualAccordion:occupationStatus\"]/div[3]"))).click();
        Thread.sleep(4000);
...
//        actions.sendKeys(Keys.ARROW_DOWN).sendKeys(Keys.ARROW_DOWN).sendKeys(Keys.ENTER).perform();
    ...
    public void enterPlaceOfIncorporation(String poi) throws InterruptedException {
        Thread.sleep(1500);
...
//            jse.executeScript("document.getElementById('FlexibleFormEntity:declarationDate_input').setAttribute('value', '01/01/2018')");
        ...
        if (taxtype.equals("Personal Income Tax(PIT) Return")) {
            ...
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("FlexibleFormEntity:TabView:Attachment:j_id1"))).click();
...
//            Thread.sleep(2000);
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("FlexbleFormAttachment:id_reference"))).sendKeys("Annual Financial Statements");
//            Timestamp timestamp = new Timestamp(System.currentTimeMillis());
...
//            Thread.sleep(1000);
            ...
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[contains(text(),'EMPLOYMENT INCOME')]"))).click();
            Thread.sleep(2000);
            driver.findElement(By.id("FlexibleFormEntity:TabView:SalaryWages_input")).sendKeys("100000");
